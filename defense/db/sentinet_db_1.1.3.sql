...
CREATE TABLE `attendance_logs` (
  ...
  KEY `attendance_logs_ibfk_2` (`shift_id`),
  CONSTRAINT `attendance_logs_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `attendance_logs_ibfk_2` FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`shift_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (1,'alice.santos','scrypt:32768:8:1$TOh2RHmsuFTfSKa3$4be4c23138272a9760444b122d115bb36c3235f1c1cd4e019f31234bc3583e62c4dcb04841634b21c0bfed15794d01308301ae7d52047d452921a46080d407ca',NULL,'employee','2025-09-20 05:46:38'),(2,'brian.lopez','scrypt:32768:8:1$M5YpYZyWj6KaDs6a$fb1f5610eee5008c55562d853cac6c34d8c8f22a24a8da08f84cbd4792be15950c4d113d16d9800e9d7debc28bf7352fa274c1768b571dc7697db32fe98fe7ea',NULL,'employee','2025-09-20 05:46:38'),(3,'cathy.reyes','scrypt:32768:8:1$MStZSPByEIwoTjTo$d8ccf71b35dd16c44c0f61dcc38775f49fc6ef420774436571994704d9e6d2bfda751a9b31cd9b75cb4e0ec0025611ec23ee7537af47edd7f53ca1558ebe94a3',NULL,'employee','2025-09-20 05:46:38'),(4,'daniel.cruz','scrypt:32768:8:1$aQFAq7iqKIZzTPoF$c63fde03c8a30ef40a724285a6ce477dbbbb9adac214b8aedb64fd27bb6c08eb3f89aa9d796ef33f58c3f834930ae4f8695d866163c914379da4aa88477fe68d',NULL,'employee','2025-09-20 05:46:38');
...
-- Dump completed on 2025-09-21 19:03:13
